...
`廣韻小韻` 包括：`小韻號`, `小韻`, `母`, `開合`, `等`, `韻`, `重紐`, `上字`, `下字`, `古韻羅馬字`, `有女羅馬字`, `白一平轉寫`, `推導中州音`, `推導普通話`

`廣韻字頭` 包括：`小韻號`, `小韻內字序`, `字頭`, `解釋`

為便於使用，還創建了兩個視圖：`廣韻小韻全` (共 3874 行) 與 `廣韻字頭全` (共 25333 行)。

`廣韻小韻全` 包括：`小韻號`, `小韻`, `小韻全名`, `音韻地位`, `母號`, `母`, `開合`, `等`, `等漢字`, `韻`, `韻賅上去`, `韻賅上去入`, `攝`, `重紐`, `聲`, `上字`, `下字`, `反切`, `古韻羅馬字`, `有女羅馬字`, `白一平轉寫`, `推導中州音`, `推導普通話`

`廣韻字頭全` 包括：`字頭號`, `字頭`, `解釋`, `小韻號`, `小韻`, `小韻全名`, `音韻地位`, `小韻內字序`, `母號`, `母`, `開合`, `等`, `等漢字`, `韻`, `韻賅上去`, `韻賅上去入`, `攝`, `重紐`, `聲`, `上字`, `下字`, `反切`, `古韻羅馬字`, `有女羅馬字`, `白一平轉寫`, `推導中州音`, `推導普通話`
